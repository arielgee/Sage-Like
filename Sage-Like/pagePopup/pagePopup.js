...
(function() {
	...
	function onRuntimeMessage(message) {
		...
		switch (message.id) {
			...
			case Global.MSG_ID_UPDATE_POPUP_DISPLAY:
	...
	function onDOMContentLoaded() {
		...
		prefs.getRootFeedsFolderId().then((folderId) => {
			...
			if(folderId === Global.ROOT_FEEDS_FOLDER_ID_NOT_SET) {
				...
				updateStatusBar(`${i18n("js_popupFeedsFolderNotSet")} <span class='pseudo-anchor' id='pagePopupOptionsHref'>${i18n("js_popupFeedsFolderNotSetLink")}</span>`);
	...
	function updateStatusBar(msg) {
		...
		slUtil.replaceInnerContent(m_elmStatusBar, STATUS_BAR_MESSEGE_PREFIX + msg);
