...
/////////////////////////////////////////////////////////////////////////////////////////////
const i18n = (messageName, substitutions = null) => browser.i18n.getMessage(messageName, substitutions);
...
const slUtil = (function() {
	...
	function createMissingPermissionsDocFrag(style) {
		...
		const str =	(`<div id='requiredPermissionsMsg' style='all:revert;${frameStyle}${style}'>` +
						...
						`<span><span id='learnMoreLink' style='${linkStyle}'>${i18n("js_commonUtilPermissionRequiredLearnMore")}</span></span><br><br>` +
						`<span id='requestPermissionsLink' style='${buttonStyle}'>${i18n("js_commonUtilPermissionRequiredButtonText")}</span>` +
	...
	function applyDocumentLocalization(doc) {
		doc.documentElement.dir = i18n("@@bidi_dir");
