...
const preferences = (function() {
	...
	function createSelectFeedsFolderElements() {
		return browser.bookmarks.getSubTree(Global.BOOKMARKS_ROOT_GUID).then((bookmarks) => {
			...
			const elmOption = createTagOption(Global.ROOT_FEEDS_FOLDER_ID_NOT_SET, i18n("js_prefsSelectFeedsFolderOptionLabel"));
	...
	function getCustomContextMenu(setName, hiddenItems) {
		...
		const ItemSet = {
			tree: {
				...
				caption: i18n("js_prefsTreeViewContextMenuBoxCaption"),
			},
			list: {
				classes: ["list-item-ctx", "list-ctx"],
				caption: i18n("js_prefsListViewContextMenuBoxCaption"),
			},
		};
