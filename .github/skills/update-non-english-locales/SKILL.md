...
- /update-non-english-locales In the 'Sage-Like\_locales\en\messages.json' file the keys "js_x", "js_y" and "js_z" were added. Synchronize changed English keys in messages.json to all non-English locales under 'Sage-Like/_locales' and ensure concatenated grammar if any is correct.
